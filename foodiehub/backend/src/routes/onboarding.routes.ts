...
import { getOnboarding, onboardingByWhatsApp, startOnboarding, submitOnboardingDetails } from '../controllers/onboarding.controller';
...
router.post('/whatsapp-chat', asyncHandler(onboardingByWhatsApp));
